...
# grafana.com/ebpf-autoinstrument-operator-bundle:$VERSION and grafana.com/ebpf-autoinstrument-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= grafana.com/ebpf-autoinstrument-operator
...
.PHONY: kind-load
kind-load: ## Loads the built image into local Kind cluster
